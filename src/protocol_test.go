...
func TestProtocolHandler(t *testing.T) {
	...
	checkReturns(t, "HandleProtocol SET String", c1, "SET", k1, "key1", vs1, []interface{}{"OK"}, err)

	// Testing for Integer
	c2, k2, vs2, err := server.HandleProtocol([]byte("SET\r\nkey2\r\n:80\r\n"))
	checkReturns(t, "HandleProtocol SET Integer", c2, "SET", k2, "key2", vs2, []interface{}{80}, err)

	// Testing for Binary
	c3, k3, vs3, err := server.HandleProtocol([]byte("SET\r\nkey3\r\n$sliceofbytes\r\n"))
	checkReturns(t, "HandleProtocol SET Binary", c3, "SET", k3, "key3", vs3, []interface{}{[]byte("sliceofbytes")}, err)

	// Testing for String
	c4, k4, vs4, err := server.HandleProtocol([]byte("GET\r\nkey4\r\n"))
	checkReturns(t, "HandleProtocol SET String", c4, "GET", k4, "key4", vs4, []interface{}{}, err)
}
